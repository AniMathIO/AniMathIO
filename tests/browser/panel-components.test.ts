...
describe("Panel Components", () => {
  it("should render AnimationsPanel component", async () => {
    const { default: AnimationsPanel } = await import(
      "../../renderer/pages/components/panels/AnimationsPanel"
    );
  ...
  it("should render AudioMixerPanel component", async () => {
    const { default: AudioMixerPanel } = await import(
      "../../renderer/pages/components/panels/AudioMixerPanel"
    );
  ...
  it("should render AudioResourcesPanel component", async () => {
    const { default: AudioResourcesPanel } = await import(
      "../../renderer/pages/components/panels/AudioResourcesPanel"
    );
  ...
  it("should render ElementsPanel component", async () => {
    const { default: ElementsPanel } = await import(
      "../../renderer/pages/components/panels/ElementsPanel"
    );
  ...
  it("should render ExportVideoPanel component", async () => {
    const { default: ExportVideoPanel } = await import(
      "../../renderer/pages/components/panels/ExportVideoPanel"
    );
  ...
  it("should render FillPanel component", async () => {
    const { default: FillPanel } = await import(
      "../../renderer/pages/components/panels/FillPanel"
    );
  ...
  it("should render ImageResourcesPanel component", async () => {
    const { default: ImageResourcesPanel } = await import(
      "../../renderer/pages/components/panels/ImageResourcesPanel"
    );
  ...
  it("should render MafsPanel component", async () => {
    const { default: MafsPanel } = await import(
      "../../renderer/pages/components/panels/MafsPanel"
    );
  ...
  it("should render TextResourcesPanel component", async () => {
    const { default: TextResourcesPanel } = await import(
      "../../renderer/pages/components/panels/TextResourcesPanel"
    );
  ...
  it("should render VideoResourcesPanel component", async () => {
    const { default: VideoResourcesPanel } = await import(
      "../../renderer/pages/components/panels/VideoResourcesPanel"
    );
