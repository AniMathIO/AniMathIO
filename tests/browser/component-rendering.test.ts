...
describe('Component Rendering Tests', () => {
  ...
  it('should handle form inputs', () => {
    ...
    const inputElement = document.querySelector('[data-testid="test-input"]') as HTMLInputElement
  ...
  it('should handle button clicks', () => {
    ...
    const buttonElement = document.querySelector('[data-testid="test-button"]') as HTMLButtonElement
  ...
  it('should handle nested elements', () => {
    ...
    const containerElement = document.querySelector('[data-testid="container"]')
