...
const PlotInputs = ({ plotProps, setPlotProps, plotInput, setPlotInput, handlePlotSubmit }: PlotInputsProps) => {
    return (
        <>
            <div className="mb-4">
                <label htmlFor="plotFunction" className="block font-medium mb-1 text-black dark:text-white">
                    Function
                </label>
            ...
            <button className="bg-blue-500 mb-2 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-sm" onClick={handlePlotSubmit} >
                Submit Plot
            </button>
        </>
    );
